...
namespace cowsins {
    ...
    public class Crosshair : MonoBehaviour {
        ...
        private void Update() {
            ...
            if(inputActions.Player.Firing.IsPressed() && player.weaponController != null && player.weaponController.canShoot)
        ...
        void OnGUI() {
            if(playerStats.isDead
                || weaponController.weapon != null && weaponController.isAiming && player.weaponController.removeCrosshairOnAiming || !isVisible) return;
