...
namespace cowsins {
    public class WeaponAnimator : MonoBehaviour {
        ...
        void FixedUpdate() {
            ...
            if(rb.linearVelocity.magnitude > player.crouchSpeed && !wc.shooting && player.currentSpeed < player.runSpeed && player.grounded) CowsinsUtilities.PlayAnim("walking", currentAnimator);
