    ...
    public class WeaponDefaultState : WeaponBaseState
    {
        ...
        public override void CheckSwitchState()
        {
            if (controller.canShoot &&
                (controller.id.bulletsLeftInMagazine > 0 || controller.weapon.shootStyle == ShootStyle.Melee) &&
        ...
        {
            if (!inputActions.Player.Aiming.IsPressed()) controller.StopAim();
        }
        ...
        {
            return inputActions.Player.Reloading.IsPressed() && (int)controller.weapon.shootStyle != 2 &&
                   controller.id.bulletsLeftInMagazine < controller.id.magazineSize && controller.id.totalBullets > 0
                   || controller.id.bulletsLeftInMagazine <= 0 && controller.autoReload &&
                   (int)controller.weapon.shootStyle != 2 &&
                   controller.id.bulletsLeftInMagazine < controller.id.magazineSize && controller.id.totalBullets > 0;
        }
    }
}